...
class Program
{
    ...
    public static async Task Main()
    {
        ...
        try
        {
            ...
            Console.WriteLine("Weather data for " + coordinatesDataClass.CountryCityCoordinates[countryChoice - 1].cities[cityChoice - 1].city + ", " + coordinatesDataClass.CountryCityCoordinates[countryChoice - 1].country);
